<template>
  <div class="text-left w-full p-4 space-y-6">
    ...
    <!-- Dates Section -->
    <div v-if="projekt.dates" class="bg-gray-100 p-6 rounded-lg shadow-md">
...
export default {
  ...
  data() {
    return {
      projekt: research.find((p) => p.id === this.$route.params.id),
    };
  },
  methods: {
    goBack() {
